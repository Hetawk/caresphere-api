...
class OrganizationInDB(OrganizationBase):
    ...
    id: str
    organization_code: str = Field(..., description="7-digit organization code")
    is_active: bool
    created_at: datetime
    updated_at: datetime
...
class OrganizationWithCode(OrganizationPublic):
    ...
    organization_code: str = Field(..., description="7-digit organization code for inviting members")
