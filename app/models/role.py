...
class Permission(UUIDPrimaryKeyMixin, TimestampMixin, Base):
    ...
    name = Column(String(100), unique=True, nullable=False)  # e.g., "manage_members"
    display_name = Column(String(255), nullable=False)  # e.g., "Manage Members"
    description = Column(String(500))
    category = Column(String(50), nullable=False)  # e.g., "members", "messages", "settings"
...
class Role(UUIDPrimaryKeyMixin, TimestampMixin, Base):
    ...
    name = Column(String(100), nullable=False)  # e.g., "Youth Leader", "Treasurer"
    display_name = Column(String(255), nullable=False)
    description = Column(String(500))
    is_system = Column(Boolean, default=False)  # System roles (super_admin, admin, etc.) cannot be deleted
...
class OrganizationUser(UUIDPrimaryKeyMixin, TimestampMixin, Base):
    ...
    joined_at = Column(String(50), nullable=True)  # Date user accepted invitation
